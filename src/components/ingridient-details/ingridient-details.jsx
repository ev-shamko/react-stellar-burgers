...
function IngridientDetais({ingrInModalData: ingridientData}) {
    return (
        <>
            <h2 className={stylesID.modalHeader + ' text  text_type_main-large mt-10 ml-10 mb-3'}>Детали ингредиента</h2>
            <img src={ingridientData['image_large']} alt={ingridientData['name']} className={stylesID.ingrImage + ' mb-4'} />
            <p className={'text  text_type_main-medium mb-4'}>{ingridientData['name']}</p>
            ...
            <ul className={stylesID.ingrInfo}>
                <li className={stylesID.nutrient}>
                    ...
                    <p className={stylesID.nutrientValue + ' text text_type_digits-default  text_color_inactive'}>{ingridientData['calories']}</p>
                </li>
                <li className={stylesID.nutrient + ' text  text_type_main-default text_color_inactive'}>
                    ...
                    <p className={stylesID.nutrientValue + ' text text_type_digits-default  text_color_inactive'}>{ingridientData['proteins']}</p>
                </li>
                <li className={stylesID.nutrient + ' text  text_type_main-default text_color_inactive'}>
                    <h5 className={stylesID.nutrientHeader + ' text  text_type_main-default text_color_inactive'}>Жиры, г</h5>
                    <p className={stylesID.nutrientValue + ' text text_type_digits-default  text_color_inactive'}>{ingridientData['fat']}</p>
                </li>
                <li className={stylesID.nutrient + ' text  text_type_main-default text_color_inactive'}>
                    <h5 className={stylesID.nutrientHeader + ' text  text_type_main-default text_color_inactive'}>Углеводы, г</h5>
                    <p className={stylesID.nutrientValue + ' text text_type_digits-default  text_color_inactive'}>{ingridientData['carbohydrates']}</p>
                </li>
            </ul>
            <p></p>
            <p></p>
