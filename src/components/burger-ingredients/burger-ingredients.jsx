                ...
                <div className={ingrStyles.ingrDisplay + ' mt-10'}>
                    ...
                    <div className={ingrStyles.ingrShowcase}>
                        ...
                        <div className={ingrStyles.ingrList}>
                            <CardList type={"bun"} ingridients={allIngridients} openModal={openModal} />
                        </div>
                    </div>
                    ...
                    <div className={ingrStyles.ingrShowcase}>
                        ...
                        <div className={ingrStyles.ingrList}>
                            <CardList type={"sauce"} ingridients={allIngridients} openModal={openModal} />
                        </div>
                    </div>
                    ...
                    <div className={ingrStyles.ingrShowcase}>
                        ...
                        <div className={ingrStyles.ingrList}>
                            <CardList type={"main"} ingridients={allIngridients} openModal={openModal} />
                        </div>
                    </div>
